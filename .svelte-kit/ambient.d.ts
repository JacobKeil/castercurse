...
declare module '$env/static/private' {
	...
	export const SECRET_TWITCH_SECRET: string;
...
declare module '$env/static/public' {
	...
	export const PUBLIC_TWITCH_AUTH_CALLBACK: string;
}
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_TWITCH_CLIENT_ID: string;
		PUBLIC_TWITCH_AUTH_CALLBACK: string;
