...
<div class="w-full space-y-2 rounded-md bg-zinc-800 px-5 py-4">
	...
	<label class="flex gap-2 items-center text-sm text-gray-400">
		<Switch
			size="md"
			color="danger"
	...
	<label class="flex gap-2 items-center text-sm text-gray-400">
		<Switch
			size="md"
			color="danger"
			bind:checked={$settings.middle_click_hide}
		/>
	...
	<label class="flex gap-2 items-center text-sm text-gray-400">
		<Switch
			size="md"
			color="danger"
			bind:checked={$settings.sidebar_top}
		/>
	...
	<label class="flex gap-2 items-center text-sm text-gray-400">
		<Switch
			size="md"
			color="danger"
			bind:checked={$settings.open_chat}
		/>
