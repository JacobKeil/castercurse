...
-- CreateTable
CREATE TABLE "_channels_on_teams" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_channels_on_teams_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_channels_on_teams_B_index" ON "_channels_on_teams"("B");
...
-- AddForeignKey
ALTER TABLE "_channels_on_teams" ADD CONSTRAINT "_channels_on_teams_A_fkey" FOREIGN KEY ("A") REFERENCES "Channel"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_channels_on_teams" ADD CONSTRAINT "_channels_on_teams_B_fkey" FOREIGN KEY ("B") REFERENCES "Team"("id") ON DELETE CASCADE ON UPDATE CASCADE;
